...
\begin{picture}(7920.00,5616.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(1100,2541){\makebox(0,0)[r]{\strut{}$1\times10^{22}$}}%
      \put(1100,4443){\makebox(0,0)[r]{\strut{}$1\times10^{23}$}}%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{/export/scratch/vbotka-thesis/Plot/Figures/fig-7-3a-en}}%
    \gplfronttext
  \end{picture}%
\endgroup
