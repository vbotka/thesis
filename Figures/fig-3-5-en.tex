...
\begin{picture}(7920.00,5616.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(4329,140){\makebox(0,0){\strut{}Depth $[\mu m]$}}%
      \put(4329,5315){\makebox(0,0){\strut{}Constant width SCR method}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{/export/scratch/vbotka-thesis/Plot/Figures/fig-3-5-en}}%
    \gplfronttext
  \end{picture}%
\endgroup
