...
\begin{picture}(7920.00,5616.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%%
      \put(5985,2989){\makebox(0,0)[r]{\strut{}${C}_{mos}^{HF}$}}%
      \csname LTb\endcsname%%
      \put(5985,3447){\makebox(0,0)[r]{\strut{}${\varphi}_{s}^{HF}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{/export/scratch/vbotka-thesis/Plot/Figures/fig-3-2-en}}%
    \gplfronttext
  \end{picture}%
\endgroup
