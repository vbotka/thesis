...
\begin{picture}(7920.00,5616.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(4209,140){\makebox(0,0){\strut{}Depth $[\mu{m}]$}}%
      \put(4209,5315){\makebox(0,0){\strut{}Generation time of minority carriers}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{/export/scratch/vbotka-thesis/Plot/Figures/fig-3-6-en}}%
    \gplfronttext
  \end{picture}%
\endgroup
