...
set output "/export/scratch/vbotka-thesis/Plot/Figures/fig-7-5-sk.tex"
# set output '/export/scratch/vbotka-thesis/Plot/Figures/fig-7-5-sk.pdf'
...
# set logscale x 10
set logscale y 10
set title "Provnanie nameraných a simulovaných kocentrácií dopantov."
