file = "/export/scratch/vbotka-thesis/Plot/Figures/fig-X-4.csv"
# set output "/export/scratch/vbotka-thesis/Plot/Figures/fig-X-4-en.tex"
set output '/export/scratch/vbotka-thesis/Plot/Figures/fig-X-4-en.pdf'
