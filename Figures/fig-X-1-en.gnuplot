file = "/export/scratch/vbotka-thesis/Plot/Figures/fig-X-1.csv"
#set output "/export/scratch/vbotka-thesis/Plot/Figures/fig-X-1-en.tex"
set output '/export/scratch/vbotka-thesis/Plot/Figures/fig-X-1-en.pdf'
