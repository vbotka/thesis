file = "/export/scratch/vbotka-thesis/Plot/Figures/fig-X-6.csv"
# set output "/export/scratch/vbotka-thesis/Plot/Figures/fig-X-6-en.tex"
set output '/export/scratch/vbotka-thesis/Plot/Figures/fig-X-6-en.pdf'
