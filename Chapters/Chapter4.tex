...
\chapter{Metódy určenia ďalších parametrov štruktúry MOS.} % Main chapter title

\label{Chapter4} % For referencing the chapter elsewhere, use \ref{Chapter1} 

\lhead{Chapter 4. \emph{Metódy určenia ďalších parametrov štruktúry MOS}} % This is for the header on each page - perhaps a shortened title
...
\includegraphics{Figures/fig-4-1.eps}
...
\begin{figure}[h!]\centering
\includegraphics{Figures/fig-4-2.eps}
\captionsetup{justification=raggedright, singlelinecheck=false}
...
\par Pri výpočte $N(x)$ pomocou vzťahov \ref{eq:4.1}, \ref{eq:4.2},
...
\bibitem[4.1]{4.1} Lehovec K.: Solid St.  Electron.  27 (1984) s.1907.
\bibitem[4.2]{4.2} Wu Chung P., Douglas E.C., Mueller C.W.: IEEE
  Trans. on elektron. dev. 22 (1975) s.319.
\bibitem[4.3]{4.3} Kroemer H., Chien W.: Solid St. Electron. 24 (1981)
  s.655.
...
\bibitem[4.12]{4.12} Balland B., Remaki B., Marchand J.J.: J. Phys. E:
