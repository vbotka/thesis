...
\lhead{Chapter 3. \emph{Methods used to measure MOS structure}}
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
Q-C method~\cite{3.4} is a combination of high frequency C-V method
